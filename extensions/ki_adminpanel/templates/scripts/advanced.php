    ...
    <form id="adminPanel_extension_form_editadv" action="../extensions/ki_adminpanel/processor.php" method="post">
        ...
        <fieldset class="adminPanel_extension_advanced">
            ...
            <div>
                ...
                <?php echo $this->formSelect('config[values][UI][language]', $this->kga->getLanguage(true), array('class' => 'formfield'), array_combine($this->languages, $this->languages)); ?>
            </div>
            <div>
            ...
            <div>
                <?php echo $this->formSelect('config[values][SYS][phpTimeZone]', $GLOBALS['KIMAI_CONF_VARS']['SYS']['phpTimeZone'], null, array_combine($this->timezones, $this->timezones));
